...
Report bugs at https://gitlab.com/draconus21/object_tracking/issues.
...
Object Tracking could always use more documentation, whether as part of the
official Object Tracking docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://gitlab.com/draconus21/object_tracking/issues.
...
Ready to contribute? Here's how to set up `object_tracking` for local development.

#. Start from an issue (create one if it does not exist) at https://gitlab.com/draconus21/object_tracking/issues.
...
#. Clone the repo locally::
    ...
    $ git clone https://gitlab.com/draconus21/object_tracking.git
...
$ pytest tests.test_object_tracking
